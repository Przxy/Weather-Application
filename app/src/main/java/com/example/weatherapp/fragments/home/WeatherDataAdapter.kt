    ...
    inner class CurrentLocationViewHolder(
        ...
        fun bind(currentLocation: CurrentLocation) {
            with(binding) {
                ...
                // Mengganti setOnClickListener menjadi setOnTouchListener
                imageCurrentLocation.setOnTouchListener { v, event ->
                    when (event.action) {
                        ...
                        MotionEvent.ACTION_UP -> {
                            // Ketika dilepas (opsional jika ada behavior lain yang ingin ditambahkan)
                            true
                        }
                        else -> false
                    }
                ...
                textCurrentLocation.setOnTouchListener { v, event ->
                    when (event.action) {
                        MotionEvent.ACTION_DOWN -> {
                            onLocationClicked()
                            true
